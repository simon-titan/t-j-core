...
export function LogoTab({ org }: Props) {
  ...
  return (
    <VStack align="stretch" gap="var(--space-7)">
      {/* Preview area */}
      <Box>
        <Text
        ...
        >
          {currentLogo ? (
            ...
            <Box color="var(--mute)" opacity={0.4}>
      ...
      <Box>
        ...
        <Text
          ...
          lineHeight={1.55}
        >
          JPEG, PNG oder WebP · Max. 5 MB · Wird in der Topbar als Org-Logo angezeigt.
        </Text>
        ...
        <HStack gap="var(--space-3)" flexWrap="wrap">
          ...
          >
            ...
            Datei wählen{file ? ` · ${file.name.slice(0, 20)}…` : ''}
          </Box>
